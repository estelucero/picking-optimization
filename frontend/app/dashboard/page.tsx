  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-1">Silk Warehouse</h1>
          <p className="text-slate-600 dark:text-slate-400">Welcome to your warehouse management dashboard</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 p-8">
          <div className="space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              The warehouse mapping algorithm has identified 4 potential bottlenecks in Zone B. Would you like to start a new experiment?
            </p>
            <Link href="/experimentation">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white">
                Run Optimization
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-blue-200 dark:border-slate-700 p-6 shadow-lg">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">ACTIVE CONFIGURATION</p>
            <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-2">High-Velocity Flow</h3>
          </div>
          <div className="flex items-center gap-6">
            <div>
              <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">Efficiency Gain</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          return (
            <div key={idx} className="bg-white dark:bg-slate-800 rounded-2xl border border-blue-200 dark:border-slate-700 p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  {metric.subtitle && <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{metric.subtitle}</p>}
                </div>
              </div>
            </div>
          )
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-blue-200 dark:border-slate-700 p-8 shadow-lg h-96 flex flex-col items-center justify-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">Product Mapping Trends</p>
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-2">Coming soon</p>
        </div>

        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-blue-200 dark:border-slate-700 p-8 shadow-lg h-96 flex flex-col items-center justify-center">
          <div className="text-6xl mb-4">🗺️</div>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Live Warehouse Map</p>
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-2">Coming soon</p>
        </div>
      </div>
    </div>
